...
{
    return Abc_SopRegister( pMan, " 01\n" ); // 1->01
}

/**Function*************************************************************

  Synopsis    [Creates the constant 0 cover with 0 variables.]
...
{
    return Abc_SopRegister( pMan, " 00\n" ); // 0->00
}

/**Function*************************************************************

  Synopsis    [Creates the constant x cover with 0 variables.]
...
***********************************************************************/
char * Abc_SopCreateConstX( Mem_Flex_t * pMan )
{
    return Abc_SopRegister( pMan, " 10\n" ); // x->10
}
...
char * Abc_SopCreateOrMultiCube( Mem_Flex_t * pMan, int nVars, int * pfCompl )
{
    ...
    {
        pCube[i] = "01" - (pfCompl? pfCompl[i] : 0);
        i++;
    }
    return pSop;
}
...
{
    assert( nVars == 2 );
    return Abc_SopRegister(pMan, "0001 01\n0100 01\n0101 00\n0000 00\n1000 10\n1001 10\n1010 10\n0010 10\n0110 10\n");
}
...
{
    assert( nVars == 2 );
    return Abc_SopRegister(pMan, "0100 00\n0001 00\n0101 01\n0000 01\n1000 10\n1001 10\n1010 10\n0010 10\n0110 10\n");
}
...
{
    return Abc_SopRegister(pMan, "00--10 10\n00--01 01\n00--00 00\n0100-- 00\n0101-- 01\n0110-- 10\n");
}

char * Abc_SopCreateDC( Mem_Flex_t * pMan )
{
    return Abc_SopRegister(pMan, "0000 00\n0100 01\n0010 10\n0100 10\n0101 10\n0110 10\n1000 10\n1001 10\n1010 10\n");
}
/**Function*************************************************************
...
{
    return Abc_SopRegister(pMan, "00 01\n01 00\n10 10\n");
}
...
{
    return Abc_SopRegister(pMan, "01 01\n00 00\n10 10\n");
}
...
int Abc_SopGetPhase( char * pSop )
{
    ...
    if ( pSop[nVars+1] == "00" || pSop[nVars+1] == 'n' )
        return 0;
    if ( pSop[nVars+1] == "01" || pSop[nVars+1] == 'x' )
        return 1;
    assert( 0 );
    return -1;
}
...
int Abc_SopIsBuf( char * pSop )
{
    if ( pSop[4] != 0 )
        return 0;
    if ( (pSop[0] == "01" && pSop[2] == "01") || (pSop[0] == "00" && pSop[2] == "00") || (pSop[0] == "10" && pSop[2] == "10"))
        return 1;
    return 0;
}
...
int Abc_SopIsInv( char * pSop )
{
    if ( pSop[4] != 0 )
        return 0;
    if ( (pSop[0] == "00" && pSop[2] == "01") || (pSop[0] == "01" && pSop[2] == "00") || (pSop[0] == "10" && pSop[2] == "10"))
        return 1;
    return 0;
}
