...
/**Function*************************************************************
  ...
  Synopsis    [Creates DC function with nVars inputs.]
...
***********************************************************************/
Hop_Obj_t * Hop_CreateDC( Hop_Man_t * p)
{
    Hop_Obj_t * pFunc;
    pFunc = Hop_ManConst1( p );
    pFunc = Hop_And( p, pFunc, Hop_IthVar(p, 0) );
    return pFunc;
}

Hop_Obj_t * Hop_DC( Hop_Man_t * p, Hop_Obj_t * pD, Hop_Obj_t * pC)
{
    return Hop_And(p,Hop_Not(pD),pC);
}
/**Function*************************************************************
