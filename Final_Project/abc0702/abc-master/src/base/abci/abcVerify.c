...
{
    Abc_Obj_t * pNode;
    int * pValues, Value0, Value1, ValueX, i;
    int fStrashed = 0;
...
*/
    ...
    Abc_NtkForEachNode( pNtk, pNode, i )
    {
        ...
        ValueX = ((int)(ABC_PTRINT_T)Abc_ObjFaninX(pNode)->pCopy) ^ (int)Abc_ObjFaninCX(pNode);
        pNode->pCopy = (Abc_Obj_t *)(ABC_PTRINT_T)(Value0 & Value1 & ValueX);
    }
