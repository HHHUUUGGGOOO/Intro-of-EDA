...
struct Abc_Obj_t_     // 48/72 bytes (32-bits/64-bits)
{
    ...
    unsigned          fComplX :  1;  // complemented attribute of the third fanin in the AIG 
...
static inline Abc_Obj_t * Abc_ObjFaninX( Abc_Obj_t * pObj )          { return (Abc_Obj_t *)pObj->pNtk->vObjs->pArray[ pObj->vFanins.pArray[2] ];   }
...
static inline int         Abc_ObjFaninCX( Abc_Obj_t * pObj )         { return pObj->fComplX;                                                }
...
extern ABC_DLL Abc_Obj_t *        Abc_AigConstX( Abc_Ntk_t * pNtk );
...
extern ABC_DLL Abc_Obj_t *        Abc_AigDC( Abc_Aig_t * pMan, Abc_Obj_t * p0, Abc_Obj_t * p1 );
...
extern ABC_DLL Abc_Obj_t *        Abc_NtkCreateNodeDC( Abc_Ntk_t * pNtk, Abc_Obj_t * pNodeD, Abc_Obj_t * pNodeC );
...
extern ABC_DLL char *             Abc_SopCreateDC( Mem_Flex_t * pMan );
